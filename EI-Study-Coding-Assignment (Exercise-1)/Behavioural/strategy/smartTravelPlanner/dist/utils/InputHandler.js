...
export class InputHandler {
    ...
    async promptForTravelOptions() {
        ...
        const timeLimit = parseFloat(await this.promptInput("Time limit (hours): "));
        const passengers = parseInt(await this.promptInput("Number of passengers: "));
        ...
        const comfortPreference = (await this.promptForPreference("Comfort preference", ["basic", "standard", "luxury"]));
        return {
            origin,
            destination,
            distance,
    ...
    async promptForPreference(label, options) {
        console.log(`${label}:`);
